...
/**
 * Randomly jumps out of water in parabolic trajectory
 * @author maheshkurmi
 *
 */
public class JumpingFish extends Creature {
	...
	public JumpingFish(int x, int y, boolean isblue) {
		super(x, y);
		this.isBlue=isblue;
	    initY=y+80;
		this.y=initY;
		//setIsItem(true);
		TextureRegion[] v = isBlue?MarioResourceManager.instance.creatures.BlueFish:MarioResourceManager.instance.creatures.RedFish;
