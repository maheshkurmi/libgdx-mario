...
/**
 * One way collision platform which is of 4 kinds
...
public class Platform extends Creature {
	...
	public Platform(int pixelX, int pixelY) {
		...
		mayfall=true;
		canJumpThrough=true;
		TextureRegion red_platform = MarioResourceManager.instance.creatures.Red_Platform_2;
	...
	public void updateCreature(TileMap map, int time) {
		...
		if (mayfall) {
			if (beginfall) {
				...
				if (y > TileMap.tilesToPixels(map.getHeight()))
					kill();
			}
			return;
		}
