...
public class CreatureEmitter extends Creature {
	...
	public CreatureEmitter(int x, int y) {
	...
	private void fireRandomCreature(TileMap map){
		...
		case 4:
		case 5:
			c= new Goomba(x,(int)getY());
			break;
		case 6:
		case 7:
		case 8:
			c=   new RedKoopa(x,(int)getY(),true);
			break;
		case 9:
		case 10:
			c=   new RedKoopa(x,(int)getY(),false);
			break;
		case 11:
			c=   new Thorny(x,(int)getY());
			break;
		case 12:
		...
		case 13:
			...
			break;
		case 14:
			//map.creaturesToAdd().add(new FlyRedKoopa(x,(int)getY(),MarioSoundManager.instance));
		default:	
			c=  new Goomba(x,(int)getY());
