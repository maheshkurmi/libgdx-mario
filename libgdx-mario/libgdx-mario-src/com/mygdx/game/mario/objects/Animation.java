...
public class Animation {
	 ...
	 */
	public Animation addFrame(TextureRegion image) {
	 ...
	 * @returns this Animation with the added frame.
	 */
	public Animation addFrame(TextureRegion image, long duration) {
	...
	public int getHeight() {
		return getFrame(currFrameIndex).image.getRegionHeight();
	}
	 ...
	 */
	public int getWidth() {
		if(getFrame(currFrameIndex).image ==null){
			Gdx.app.log( "err",this.getClass().getName());
			return 16;
		}
		return getFrame(currFrameIndex).image.getRegionWidth();
	}
    ...
    public TextureRegion[] getImages() {
    	if(frames.size() == 0) {
    		...
    		return (TextureRegion[]) frames.toArray();
    	}
    }
    ...
    private class AnimFrame {
        ...
        public AnimFrame(TextureRegion image, long endTime) {
            this.image = image;
