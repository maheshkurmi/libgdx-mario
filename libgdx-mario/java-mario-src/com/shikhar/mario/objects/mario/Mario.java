...
import com.shikhar.mario.core.GamePanel;
...
public class Mario extends CollidableObject{
    ...
    public Mario(MarioSoundManager22050Hz soundManager) {
		...
		new MarioSoundManager10512Hz(new AudioFormat(10512, 8, 1, true, true));
		
		l_Big = new BufferedImage[]{ ImageUtilities.loadImage("mario/Mario_Big_Left_Still.png"), ImageUtilities.loadImage("mario/Mario_Big_Left_1.png"),
				ImageUtilities.loadImage("mario/Mario_Big_Left_2.png"), ImageUtilities.loadImage("mario/Mario_Big_Left_Run_1.png"),
				ImageUtilities.loadImage("mario/Mario_Big_Left_Run_2.png"), ImageUtilities.loadImage("mario/Mario_Big_Crouch_Left.png"),
				ImageUtilities.loadImage("mario/Mario_Big_Jump_Left.png"), ImageUtilities.loadImage("mario/Mario_Big_Change_Direction_Left.png") };
		
		r_Big = new BufferedImage[]{ null, null, null, null, null, null, null, null };
		for(int i = 0; i < l_Big.length; i++) {
			r_Big[i] = ImageUtilities.horizontalFlip(l_Big[i]); // Flip every image in l.
		}
			
		l_Fire = new BufferedImage[]{ ImageUtilities.loadImage("mario/Mario_Big_Left_Still_Fire.png"), ImageUtilities.loadImage("mario/Mario_Big_Left_1_Fire.png"),
				ImageUtilities.loadImage("mario/Mario_Big_Left_2_Fire.png"), ImageUtilities.loadImage("mario/Mario_Big_Left_Run_1_Fire.png"),
				ImageUtilities.loadImage("mario/Mario_Big_Left_Run_2_Fire.png"), ImageUtilities.loadImage("mario/Mario_Big_Crouch_Left_Fire.png"),
				ImageUtilities.loadImage("mario/Mario_Big_Jump_Left_Fire.png"), ImageUtilities.loadImage("mario/Mario_Big_Change_Direction_Left_Fire.png") };
		
		r_Fire = new BufferedImage[]{ null, null, null, null, null, null, null, null };
		for(int i = 0; i < l_Fire.length; i++) {
			r_Fire[i] = ImageUtilities.horizontalFlip(l_Fire[i]); // Flip every image in l.
		}
	   ...
	   swim_right_fire=new SpriteMap("mario/Mario_Fire_Swim_Right.png", 4, 1).getSprites();
		...
		BufferedImage flipped = ImageUtilities.loadImage("mario/Mario_Flip.png");
		...
		if(!creature.isPlatform() && creature.isCollidable() || creature instanceof BoomRang) { 
			...
			if(collision && !(creature instanceof Score)) {
				if(creature instanceof LevelComplete) {
					...
					grace=40;
					creature.kill();
					GamePanel.SM_10512_Hz.playCelebrate();
					hasFire=true;
					small=false;
					toggleMarioFrames(1);
					soundManager.playItemSprout();
	...
	public void getsDamaged() {
		if (grace == 0) {
			if (small) {
				...
				hasFire = false;
				GamePanel.SM_10512_Hz.playHurt();
